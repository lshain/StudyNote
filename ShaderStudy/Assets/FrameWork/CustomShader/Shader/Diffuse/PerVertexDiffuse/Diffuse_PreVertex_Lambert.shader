...
Shader "Custom/Diffuse/Diffuse_PreVertex_Lambert"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			struct v2f
			{
				...
				// 存储顶点着色器中计算的光照颜色，它的值由顶点光照颜色插值得到
				fixed3 color : COLOR;
			};
			...
			v2f vert (a2v v)
			{
				...
				// _LightColor0光源颜色
				fixed3 diffuse = _LightColor0.rgb * _DiffuseColor * saturate(dot(worldNormal, worldLight));
